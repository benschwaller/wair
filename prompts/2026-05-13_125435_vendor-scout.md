...
timestamp: 2026-05-13T12:54:35.652491
---
...
**Title:** Surge in Global IT Spending Driven by Compute & Memory Price Increases, Forecasted 55.8% Datacenter Systems Growth in 2026  

**Summary:**  
Gartner’s latest forecast (April 2026) projects total worldwide IT spending to reach **$6.32 trillion** in 2026, a **13.5 %** year‑over‑year rise, largely propelled by soaring prices and shortages of CPUs, GPUs, DRAM, and flash memory. Datacenter systems—servers, switches, and storage—are expected to grow **55.8 %** to **$788 billion**, an incremental **$134.6 billion** over the previous three‑month forecast. This growth outpaces global GDP (≈2.7 % average since 2013) and pushes the share of datacenter systems in total IT spend from **4.5 % (2012)** to **12.5 % (2026)**. Core IT spending (hardware, software, services) will represent **64.9 %** of the overall IT budget, up from **35.9 %** in 2012, reflecting the dominance of AI‑driven workloads (training/inference) in hyperscalers, cloud builders, and AI model developers (e.g., Anthropic, OpenAI).

The analysis highlights that the price‑driven spending surge is not merely inflationary; it translates into **real capacity expansion** as organizations allocate capital to acquire additional compute nodes, GPU accelerators, and high‑bandwidth memory to meet GenAI demand. The forecast also notes that the incremental spend in 2026 alone equals the total datacenter systems spend of 2012‑2013 combined (nominal terms), underscoring the scale of the current hardware procurement wave.

**Source URL:** https://www.nextplatform.com/compute/2026/05/11/compute-and-memory-price-hikes-drive-it-spending-way-higher/5238181  
**Published Date:** 2026-05-11T18:06:40+02:00  
**Source Credibility:** **High** (The Next Platform – reputable industry analysis, data sourced from Gartner)  

**Operational Impact:**  
- **Capacity Planning:** HPC admins must anticipate a **significant influx of new GPU‑dense nodes** and memory‑intensive servers; budgeting cycles should accommodate higher upfront hardware costs and potential lead‑time delays.  
- **Power & Cooling:** The projected 55 % rise in datacenter systems spending implies a comparable increase in rack density; admins need to evaluate power distribution, cooling capacity, and floor‑space constraints.  
- **Software Stack Scaling:** Larger, more heterogeneous clusters will stress job schedulers (Slurm, PBS) and orchestration tools (Kubernetes, OpenShift); administrators should test scaling limits and consider hierarchical scheduling or federation.  
- **Vendor Diversification:** With shortages across multiple vendors, admins should develop multi‑vendor procurement strategies (e.g., mixing NVIDIA, AMD, Intel GPUs) to mitigate supply risk.  
- **Budget Forecasting:** Traditional CAPEX models may no longer align with rapid price volatility; admins should adopt flexible budgeting (e.g., subscription‑based HPC, cloud bursting) to absorb cost spikes.  

**Key Technical Details:**  
- **Datacenter systems spend 2026:** $788 billion (↑55.8 % YoY)  
- **Overall IT spend 2026:** $6.32 trillion (↑13.5 % YoY)  
- **Core IT share 2026:** 64.9 % of total IT budget  
- **Datacenter systems share 2026:** 12.5 % of total IT spend (vs. 4.5 % in 2012)  
- **Growth drivers:** AI training/inference demand, GPU/CPU/DRAM/Flash shortages, hyperscaler expansion (US & China)  

**Tags:** [GPU] [storage] [networking] [vendor] [research] [orchestration] [scheduler]  

**Importance:** **High**  

**Why This Matters:** The unprecedented surge in datacenter hardware spend signals a rapid expansion of GPU‑heavy HPC resources, forcing administrators to adapt capacity, power, and scheduling infrastructures while navigating volatile component pricing and supply constraints.
