...
timestamp: 2026-05-13T12:57:19.080576
---
...
**Source URL**: https://www.nextplatform.com/compute/2026/05/11/compute-and-memory-price-hikes-drive-it-spending-way-higher/5238181  
**Published Date**: 2026-05-11T18:06:40+02:00  
**Source Credibility**: [High Credibility] – The Next Platform is a well‑established industry publication with a focus on data‑center and HPC infrastructure.

### Summary
The article reports that global IT spending for 2026 is projected to reach $6.32 trillion, a 13.5 % increase over 2025, driven largely by escalating costs for CPUs, GPUs, main memory, and flash storage. Gartner’s revised forecast now projects datacenter systems spending to grow by 55.8 % to $788 billion, up from an earlier estimate of 31.7 %. This represents an incremental $134.6 billion added to the 2026 forecast within a three‑month period. The article attributes the surge to intense demand from hyperscalers, cloud builders, and AI model developers (e.g., Anthropic, OpenAI) that are investing heavily in training and inference infrastructure. It also notes that the share of datacenter hardware in overall IT spend has risen from 4.5 % in 2012 to 12.5 % in 2026, while core IT spend (hardware, software, services) now accounts for 64.9 % of the total IT budget.

The piece highlights that price hikes for compute and memory components are accelerating, with shortages exacerbating the situation. It suggests that the rapid increase in spending may outpace the rate of technological progress, potentially leading to higher capital and operational expenditures for HPC centers that rely on large GPU clusters and high‑performance memory.

### Operational Impact
- **Budget Planning**: HPC administrators must anticipate higher capital costs for GPU nodes, memory upgrades, and storage arrays. Revised procurement cycles and vendor negotiations will be required to lock in prices before further inflation.
- **Capacity Forecasting**: The projected 55.8 % growth in datacenter spend implies a need for larger clusters. Capacity planning models should incorporate higher per‑node costs to avoid budget overruns.
- **Supply Chain Resilience**: Shortages of CPUs, GPUs, and memory necessitate diversifying suppliers and considering alternative architectures (e.g., FPGA, ASIC) to mitigate risk.
- **Energy & Cooling**: Larger, more expensive clusters will consume more power; HPC sites must evaluate cooling and power delivery upgrades to support increased density.
- **Workload Scheduling**: Higher hardware costs may shift the cost–benefit analysis of running large GPU‑intensive jobs versus CPU‑based alternatives, influencing scheduler policies and priority queues.

### Key Technical Details
- **Projected IT Spend 2026**: $6.32 trillion (13.5 % YoY)
- **Datacenter Systems Spend 2026**: $788 billion (55.8 % YoY)
- **Incremental Increase (2026 forecast)**: $134.6 billion
- **Datacenter Hardware Share**: 12.5 % of total IT spend (up from 4.5 % in 2012)
- **Core IT Share**: 64.9 % of total IT spend (up from 35.9 % in 2012)
- **Drivers**: AI training/inference, hyperscaler expansion, cloud infrastructure build‑out

### Tags
[scheduler] [orchestration] [GPU] [storage] [vendor] [observability]

### Importance
**Critical**

### Why This Matters
HPC administrators must adapt budgeting, procurement, and scaling strategies to accommodate rapidly rising hardware costs and supply constraints, ensuring that performance goals can be met without exceeding financial limits.
